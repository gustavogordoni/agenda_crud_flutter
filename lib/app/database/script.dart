final createTable = '''
  CREATE TABLE contact (
    ...
    nome VARCHR(200) NOT NULL,
    telefone CHAR(16) NOT NULL,
    email VARCHR(150) NOT NULLNOT NULL,
    url_avatar VARCHR(300) NOT NULL
  );
...
final insertValues = '''
  INSERT INTO contact (nome, telefone, email, url_avatar) VALUES 
    ...
    ('Pedro', '(11) 9 9883-5256', '@pedroemail.com', 'https://www.w3schools.com/howto/img_avatar.png'),
